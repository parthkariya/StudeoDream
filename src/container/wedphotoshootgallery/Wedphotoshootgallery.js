...
import "./Wedphotoshootgallery.css";
const Wedphotoshootgallery = () => {
  return (
    <div className="main_wrapp wedphotoshoot_sec">
      <div className="base_wrapp">
...
export default Wedphotoshootgallery;
